...
design(asw_dds_behav) <- ~pc1_sign+location+behaviour+location:behaviour
##run deseq2
asw_dds_behav <- DESeq(asw_dds_behav)
saveRDS(asw_dds_behav, "output/deseq2/asw_dual/INT_WT_behaviour-location_unpara/INT_WT_behaviour-location_unpara.rds")
...
fwrite(ordered_sig_res_group_table, "output/deseq2/asw_dual/INT_WT_behaviour-location_unpara/sig_degs.csv")
fwrite(ordered_res_group_table, "output/deseq2/asw_dual/INT_WT_behaviour-location_unpara/res_group.csv")
...
fwrite(sig_annots, "output/deseq2/asw_dual/INT_WT_behaviour-location_unpara/sig_annots.csv")
