...
res_group <- fread("output/deseq2/asw_dual/INT_LRT_attack-status-location/res_group.csv")
...
fwrite(annot_sig_fgsea, "output/deseq2/INT_LRT_attack-status-location/sig_GO_enrichment.csv")
