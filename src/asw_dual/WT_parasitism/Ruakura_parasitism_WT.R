...
##only Invermay
asw_dds_inv <- asw_dds[,asw_dds$Weevil_Location=="Ruakura"]
...
ru_only <- setdiff(ordered_sig_res_group_table$rn, all_sig$rn)
...
sig_annots_ru_only <- subset(sig_annots, rn %in% ru_only)
