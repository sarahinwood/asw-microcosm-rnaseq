...
##only Ru samples
asw_dds_para <- asw_dds_para[,asw_dds_para$Weevil_Location == "Ruakura"]
##control for PC1
design(asw_dds_para) <- ~pc1_sign+para
##run deseq2
asw_dds_para <- DESeq(asw_dds_para)
saveRDS(asw_dds_para, "output/deseq2/asw_dual/WT_parasitism_ruakura/parasitism_WT.rds")

asw_dds_para <- readRDS("output/deseq2/asw_dual/WT_parasitism_ruakura/parasitism_WT.rds")
##results
...
fwrite(ordered_sig_res_group_table, "output/deseq2/asw_dual/WT_parasitism_ruakura/sig_degs.csv")
fwrite(ordered_res_group_table, "output/deseq2/asw_dual/WT_parasitism_ruakura/res_group.csv")
...
fwrite(sig_annots, "output/deseq2/asw_dual/WT_parasitism_ruakura/sig_annots.csv")
