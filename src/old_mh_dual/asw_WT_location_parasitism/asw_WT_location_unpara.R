...
res_group <- results(dds_location_parasitism, contrast = c("group", "Ruakura_undetected", "Dunedin_undetected"), lfcThreshold = 1, alpha = 0.1)
##Order based of padj
...
##write tables
fwrite(ordered_res_group_table, "output/deseq2/asw/WT_location_parasitism/location_unpara/full_res.csv")
fwrite(ordered_sig_res_group_table, "output/deseq2/asw/WT_location_parasitism/location_unpara/sig_degs.csv", col.names = TRUE, row.names = FALSE)
...
fwrite(sig_degs_annots, "output/deseq2/asw/WT_location_parasitism/location_unpara/sig_degs_annots.csv")
...
fwrite(sorted_fgsea_res, "output/deseq2/asw/WT_location_parasitism/location_unpara/fgsea_pfam_res.csv")
...
fwrite(annot_sig_fgsea, "output/deseq2/asw/WT_location_parasitism/location_unpara/sig_annot_fgsea_pfam.csv")