...
saveRDS(dds_location_attack, "output/deseq2/asw/LRT_int_location_attack/dds_int_location_attack.rds")

dds_location_attack <- readRDS("output/deseq2/asw/LRT_int_location_attack/dds_int_location_attack.rds")
...
fwrite(full_res_dt, "output/deseq2/asw/LRT_int_location_attack/LRT_int_location_para_full_res.csv")

##make list of sig genes
sig_degs <- subset(dds_res, padj<0.05)
sig_degs_names <- row.names(sig_degs)
fwrite(data.table(sig_degs_names), "output/deseq2/asw/LRT_int_location_attack/sig_degs_names.csv")
...
fwrite(ordered_sig_degs_table, "output/deseq2/asw/LRT_int_location_attack/sig_degs.csv")
##merge with annots
...
fwrite(ordered_sig_degs_annots, "output/deseq2/asw/LRT_int_location_attack/sig_degs_annots.csv")

##plot counts for genes of interest, sub in name
plotCounts(dds_location_attack, "ASW_TRINITY_DN1558_c0_g1", intgroup = c("Location", "Attack"))
...
fwrite(annot_sig_fgsea, "output/deseq2/asw/LRT_int_location_attack/sig_annot_fgsea_pfam.csv")
