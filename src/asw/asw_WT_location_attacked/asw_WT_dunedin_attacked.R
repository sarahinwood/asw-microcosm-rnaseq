...
res_group <- results(dds_location_attacked, contrast = c("group", "Dunedin_Y", "Dunedin_NO"), lfcThreshold = 1, alpha = 0.1)
##Order based of padj
...
##write tables
fwrite(ordered_res_group_table, "output/deseq2/asw/WT_location_attacked/dunedin_attacked/full_res.csv")
fwrite(ordered_sig_res_group_table, "output/deseq2/asw/WT_location_attacked/dunedin_attacked/sig_degs.csv", col.names = TRUE, row.names = FALSE)
...
fwrite(sig_degs_annots, "output/deseq2/asw/WT_location_attacked/dunedin_attacked/sig_degs_annots.csv")

EnhancedVolcano(ordered_res_group_table, x="log2FoldChange", y="padj", lab="", pointSize = 3, pCutoff=0.05)

plotCounts(dds_location_attacked, "ASW_TRINITY_DN31995_c0_g1", intgroup = c("group"))
...
fwrite(sorted_fgsea_res, "output/deseq2/asw/WT_location_attacked/dunedin_attacked/fgsea_pfam_res.csv")
...
fwrite(annot_sig_fgsea, "output/deseq2/asw/WT_location_attacked/dunedin_attacked/sig_annot_fgsea_pfam.csv")
