...
res_group <- results(dds_location_attacked, contrast = c("group", "Ruakura_Y", "Ruakura_NO"), lfcThreshold = 1, alpha = 0.1)
##Order based of padj
...
##write tables
fwrite(ordered_res_group_table, "output/deseq2/asw/WT_location_attacked/ruakura_Y/full_res.csv")
fwrite(ordered_sig_res_group_table, "output/deseq2/asw/WT_location_attacked/ruakura_Y/sig_degs.csv", col.names = TRUE, row.names = FALSE)
...
fwrite(sig_degs_annots, "output/deseq2/asw/WT_location_attacked/ruakura_Y/sig_degs_annots.csv")
...
fwrite(sorted_fgsea_res, "output/deseq2/asw/WT_location_attacked/ruakura_Y/fgsea_pfam_res.csv")
...
fwrite(annot_sig_fgsea, "output/deseq2/asw/WT_location_attacked/ruakura_Y/sig_annot_fgsea_pfam.csv")
